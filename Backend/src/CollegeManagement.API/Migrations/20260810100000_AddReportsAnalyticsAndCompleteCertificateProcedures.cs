...
[Migration("20260810100000_AddReportsAnalyticsAndCompleteCertificateProcedures")]
public partial class AddReportsAnalyticsAndCompleteCertificateProcedures : Migration
{
...
END;", suppressTransaction: true);
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        var procedures = new[]
        {
            "sp_Report_Dashboard","sp_Report_Admissions","sp_Report_StudentStrength","sp_Report_Attendance","sp_Report_FacultyAttendance",
            "sp_Report_FeeCollection","sp_Report_OutstandingFees","sp_Report_Examinations","sp_Report_Results","sp_Report_PassPercentage",
            "sp_Report_Toppers","sp_Report_Subjects","sp_Report_Groups","sp_Report_Sections","sp_Report_FacultyWorkload","sp_Report_StudentPerformance","sp_Report_AuditLogs",
            "sp_GetCertificates","sp_GetCertificateById","sp_GenerateBonafideCertificate","sp_GenerateStudyCertificate","sp_GenerateConductCertificate",
            "sp_GenerateFeeCertificate","sp_GenerateTransferCertificate","sp_UpdateCertificate","sp_GetCertificateHistory","sp_VerifyCertificate","sp_ReissueCertificate","sp_CancelCertificate","sp_MoveCertificateStatus"
        };
        foreach (var p in procedures) migrationBuilder.Sql($"DROP PROCEDURE IF EXISTS {p};", suppressTransaction: true);
        migrationBuilder.Sql("DROP TABLE IF EXISTS AuditLogs;", suppressTransaction: true);
    }
}
