...
namespace CollegeManagement.API.Migrations
{
    ...
    [Migration("20260811090033_NormalizeFacultySubjectAllocation")]
    partial class NormalizeFacultySubjectAllocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.Faculty.FacultySubjectAllocation", b =>
                {
                    ...
                    b.HasIndex("FacultyId", "SubjectId")
                        .IsUnique();

                    b.ToTable("FacultySubjectAllocations");
                });

            modelBuilder.Entity("CollegeManagement.API.Models.FeeCollection", b =>
                {
                    b.Property<int>("FeeCollectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("FeeCollectionId"));
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.FeeStructure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("FeeStructureId");
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.FeeCollection", b =>
                {
                    b.HasOne("CollegeManagement.API.Models.FeeStructure", "FeeStructure")
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.Student", b =>
                {
                    ...
                    b.HasOne("CollegeManagement.API.Models.StudentAdmission", null)
                        .WithOne("Student")
                        .HasForeignKey("CollegeManagement.API.Models.Student", "AdmissionId")
                        .OnDelete(DeleteBehavior.Restrict);
