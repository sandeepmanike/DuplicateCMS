...
namespace CollegeManagement.API.Migrations
{
    ...
    public partial class AddBoardStoredProcedures : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                CREATE PROCEDURE sp_GradingSystemExists(IN p_GradingSystemId INT)
                BEGIN
                    SELECT COUNT(*) FROM GradingSystems WHERE GradingSystemId = p_GradingSystemId AND IsActive = 1;
                END;
            """);
