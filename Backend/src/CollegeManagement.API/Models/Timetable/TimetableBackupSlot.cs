...
namespace CollegeManagement.API.Models.Timetable
{
    ...
    public class TimetableBackupSlot
    {
        [Key]
        public int Id { get; set; }

        [Required]
        public int TimetableBackupId { get; set; }

        public int? OriginalTimetableId { get; set; }
        ...
        [ForeignKey(nameof(TimetableBackupId))]
        public virtual TimetableBackup? TimetableBackup { get; set; }
