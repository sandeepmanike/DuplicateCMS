...
namespace CollegeManagement.API.DTOs.Subject
{
    public class CreateSubjectDto
    {
        ...
        [Range(0, 1000)] public int InternalMarks { get; set; }
        [Range(0, 1000)] public int PracticalMarks { get; set; }
        [Range(0, 1000)] public int ExternalMarks { get; set; }
        [Range(1, 1000)] public int TotalMarks { get; set; }
        [Range(0, 1000)] public int PassingMarks { get; set; }
